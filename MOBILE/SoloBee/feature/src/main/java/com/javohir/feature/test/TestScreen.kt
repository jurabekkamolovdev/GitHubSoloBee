...
import com.javohir.feature.test.content.PhoneContent
import com.javohir.feature.test.content.TabletContent
 ...
 * Project: SoloBee
 * Package: com.javohir.feature.test
 * Description: Test Composable Screen
 */
@Composable
fun TestScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.event.collect { event ->
            when (event) {
                ...
                is TestEvent.NavigateToWordHunt -> {
...
private fun TestContent(
    ...
    val pullRefreshState = rememberPullRefreshState(
        ...
        onRefresh = { onAction(TestIntent.Refresh) }
    )
...
fun TestPreview() {
    TestContent(
        ...
        state = TestState(
            answer = "RED",
            options = listOf(
                TestLetterOption(index = 0, char = "R", imageUrl = null),
                TestLetterOption(index = 1, char = "E", imageUrl = null),
                TestLetterOption(index = 2, char = "D", imageUrl = null),
            ),
        ),
        onAction = {},
        onBackClick = {},
